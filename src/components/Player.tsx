      ...
      <group ref={shipRef}>
          ...
          <mesh castShadow>
            ...
            <meshStandardMaterial
              ...
              emissiveIntensity={isSuper ? 10 : 2}
              metalness={1}
              roughness={0.1}
            />
          </mesh>
          ...
          <group position={[0, 0, 0.5]}>
            ...
            <mesh position={[-1.2, 0, 0.5]} rotation={[0, -0.4, 0]}>
              ...
              <meshStandardMaterial color="#00ffff" emissive="#00ffff" emissiveIntensity={5} metalness={0.8} />
            </mesh>
            {/* Right Wing */}
            <mesh position={[1.2, 0, 0.5]} rotation={[0, 0.4, 0]}>
              <boxGeometry args={[2, 0.1, 1.5]} />
          ...
          <mesh position={[0, 0.35, -0.6]} rotation={[Math.PI / 2.2, 0, 0]}>
            ...
            <meshStandardMaterial color="#050505" emissive="#00ffff" emissiveIntensity={5} transparent opacity={0.9} roughness={0} metalness={1} />
          </mesh>
